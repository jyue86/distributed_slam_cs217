 ...
 * simulated dataset This version uses iSAM to solve the problem incrementally
...
// iSAM requires as input a set set of new factors to be added stored in a
// factor graph, and initial guesses for any new variables used in the added
// factors
...
int main(int argc, char *argv[]) {
  ...
  for (size_t i = 0; i < poses.size(); ++i) {
    ...
    cout << "Size of initial estimate after inserting: "
         << initialEstimate.size() << endl;
    ...
    if (i == 0) {
      ...
      cout << "Size of graph after clearing: " << graph.size() << endl;
      cout << "Size of initial estimate after clearing: "
           << initialEstimate.size() << endl;
    }
  }
